...
public class AlfheimConfig implements ConfigRunner {
    public static final Consumer<Configuration> GENERIC_TWEAKS = configuration -> {
        ...
        LilyflowerTweaksConfigSystem.ENABLE_ESM_RACES = configuration.getBoolean("esmRacesToggle", "alfheim", true, "Enable ESM races. Useful if you want to have MMO without ESM.");
        LilyflowerTweaksConfigSystem.ENABLE_ESM_FLIGHT = configuration.getBoolean("esmFlightToggle", "alfheim", true, "Enable ESM flight.");
    };
