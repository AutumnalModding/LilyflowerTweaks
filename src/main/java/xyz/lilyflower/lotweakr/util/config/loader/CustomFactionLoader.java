package xyz.lilyflower.lotweakr.util.config.loader;
...
import xyz.lilyflower.lotweakr.core.LTRCustomDataLoader;
import xyz.lilyflower.lotweakr.util.data.CustomFactionRank;

@SuppressWarnings({"ConstantConditions", "unchecked"})
public class CustomFactionLoader implements LTRCustomDataLoader {
    private static final Logger LOGGER = LogManager.getLogger("LOTweakR Custom Factions Loader");

    @Override
    public void run() {
        File customFactionList = new File(System.getProperty("user.dir") + "/config/lotweakr/factions/");
